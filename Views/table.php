...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Controllers/asigController.php';
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <!-- <form action="../index.php?controller=UserController&action=updateView&id=<?= $usuario['id'] ?>" method="POST"> -->
                                                <form action="../index.php?controller=UserController&action=update&id=<?= $_GET['id'] ?>" method="POST">
